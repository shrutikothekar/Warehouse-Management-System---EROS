...
//    $("#ponoId").select2();  // ye d
//    $(".c").select2();  // ye d
//    $(".searchable-select").select2();  // ye d
//    $(".selectdrop").select2();  // ye d
//    $("#sonoId").select2();
...
$(function () {
    $("#ponoId").select2();  // ye d
    $(".selectdrop").select2();  // ye d
    $(".replacement").select2();  // ye d
    $("#sonoId").select2();
    $("#suppliernameId").select2();
    $("#customernameId").select2();
    $('#dataTable').DataTable();
    //$('#dataTable').DataTable({
    //    /*"order": [] // Remove any default ordering*/
    //    //"order": null // Remove any default ordering
    //    "order": [[1, "desc"]] // Order by the first column in descending order1
